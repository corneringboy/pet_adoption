...
SECRET_KEY = 'django-insecure-2op$tae6wpc#r8bl+%z(3snsf1-q5udj)p_go-x6_@9xf^_1%b'  # ❗️ Replace with env var in production
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'new_pets' / 'static',  # ✅ Using Pathlib for consistency
]
STATIC_ROOT = BASE_DIR / 'staticfiles'  # ✅ Production static files

# Media files (user uploaded content)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # ✅ Consistent Pathlib usage
